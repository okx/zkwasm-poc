...
pub const TOTAL_VALUE_UPPER_BOUND: Lazy<BigInt> = Lazy::new(|| BigInt::from(2).pow(63));
pub const TOTAL_VALUE_LOWER_BOUND: Lazy<BigInt> = Lazy::new(|| BigInt::from(2).pow(63).neg());
...
pub static FXP_32_ONE: Lazy<BigInt> = Lazy::new(|| BigInt::from(2).pow(32));

pub const ORDER_ID_UPPER_BOUND: Lazy<BigInt> = Lazy::new(|| BigInt::from(2).pow(64));
